...
find_library (GLIB_GOBJECT_LIBRARIES NAMES gobject-2.0
  PATHS ${CMAKE_EXTRA_LIBRARIES} PATH_SUFFIXES glib-2.0/ NO_DEFAULT_PATH
  )
...
endif(NOT GLIB_GOBJECT_LIBRARIES)

MARK_AS_ADVANCED(GLIB_CORE_LIBRARIES GLIB_GTHREAD_LIBRARIES GLIB_GMODULE_LIBRARIES GLIB_GOBJECT_LIBRARIES)
SET(GLIB_LIBRARIES ${GLIB_CORE_LIBRARIES} ${GLIB_GTHREAD_LIBRARIES} ${GLIB_GMODULE_LIBRARIES} ${GLIB_GOBJECT_LIBRARIES})

## -----------------------------------------------------------------------------
## Actions taken when all components have been found

if (GLIB_INCLUDE_DIRS AND GLIB_CORE_LIBRARIES AND GLIB_GTHREAD_LIBRARIES AND GLIB_GMODULE_LIBRARIES AND GLIB_GOBJECT_LIBRARIES)
  set (GLIB_FOUND TRUE)
else (GLIB_INCLUDE_DIRS AND GLIB_CORE_LIBRARIES AND GLIB_GTHREAD_LIBRARIES AND GLIB_GMODULE_LIBRARIES AND GLIB_GOBJECT_LIBRARIES)
  if (NOT GLIB_FIND_QUIETLY)
    ...
    if (NOT GLIB_GOBJECT_LIBRARIES)
      message (STATUS "Unable to find GLIB gobject-2.0 library files!")
    endif (NOT GLIB_GOBJECT_LIBRARIES)
  endif (NOT GLIB_FIND_QUIETLY)
endif (GLIB_INCLUDE_DIRS AND GLIB_CORE_LIBRARIES AND GLIB_GTHREAD_LIBRARIES AND GLIB_GMODULE_LIBRARIES AND GLIB_GOBJECT_LIBRARIES)
